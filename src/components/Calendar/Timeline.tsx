        ...
        {events.map((event, index) => {
          ...
          return (
            <motion.div
              ...
              className={`absolute top-1/2 -translate-y-1/2 h-12 rounded-lg border border-zinc-700/50 bg-zinc-800/80 backdrop-blur-sm overflow-hidden group hover:z-20 hover:border-zinc-500 transition-colors cursor-default`}
              style={{
                left: `${startPercent}%`,
                width: `${widthPercent}%`,
                minWidth: "4px",
